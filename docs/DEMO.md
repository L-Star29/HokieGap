...
2. Enter the two buildings and class time. Show that the app uses both ends of the gap, including walking and an arrival buffer. It is about usable time, not just the nearest building.
...
4. Choose another space as a backup. Change the intent to eating to show Perry Place, then open the three-stop walking route in Google Maps.
...
HokieGap currently covers nearby study, group work, quiet time, breaks and dining. Dorm trips, transit prediction and automatic calendar imports remain outside this release.
